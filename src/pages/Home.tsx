...
const Home = () => {
    ...
    // initailize the countdown timer in seconds
    const { time } = useCountdown(86400)
            ...
            <section className="mt-6">
                    ...
                    <aside className="text-center mt-[58px] relative md:text-start">
                        <div className="font-clashBold text-[32px] relative z-10 lg:text-[60px]">
                            <div className="flex justify-center relative md:justify-start">
                                ...
                                <h1 className="relative w-fit lg:leading-[5rem]">
                                    ...
                                    <img src={starWhite} alt="star-white" className="w-[10px] animate-pulse absolute -top-4 left-[3.5rem]  md:w-[16px] md:-top-32 md:-right-[6rem]" />
                                    <img src={starGray} alt="star-white" className="w-[6px] animate-pulse absolute -top-4 -right-[1.2rem] md:w-[26px] md:-top-16 md:-right-[6rem]" />
                                </h1>
                            </div>
                        ...
                        <div className="flex items-center gap-x-4 justify-center mt-[14.96px] relative md:justify-start md:mt-[77px]">
                            <Fade direction="up" delay={3000}>
                                <TimeLabel value={time.hour} unit="H" />
                            </Fade>
                            <Fade direction="up" delay={4000}>
                                <TimeLabel value={time.minute} unit="M" />
                            </Fade>
                            <Fade direction="up" delay={5000}>
                                <TimeLabel value={time.second} unit="S" />
                            </Fade>
                            <img src={starGray} alt="star-img" className="w-[8px] animate-pulse absolute -top-12 right-24  md:w-[16px] md:-top-6 md:right-40" />
                        </div>
                    </aside>
                        ...
                        <Fade direction="right" delay={400} damping={1e-1}>
                            ...
                            >
                                <>
                                    ...
                                    <img src={starPurpleOne} alt="star-icon" className="w-[12px] animate-pulse absolute right-[3rem] top-[1rem] md:right-[2.5rem] md:-bottom-[1rem] md:w-[20px]" />
                                </>
                            </SingleArticle>
                        </Fade>
                    </article>
                        ...
                        <Fade delay={400} damping={1e-1}>
                            <SingleArticle
                                ...
                                <>
                                    ...
                                    <img src={starGray} alt="star-icon" className="w-[12px] animate-pulse absolute right-[2rem] top-[3rem] md:left-[14.5rem] md:-top-[3rem] md:w-[20px]" />
                                    <img src={starWhite} alt="star-icon" className="w-[12px] animate-pulse absolute left-[7rem] -bottom-[2rem] md:left-[34.5rem] md:-bottom-[1rem] md:w-[20px]" />
                ...
                <section className="border-b border-b-slate-800" id="overview">
                    <article className="md:w-[80%] md:mx-auto md:grid md:grid-cols-2 md:gap-x-8 md:items-center py-[62px]">
                        <div className="relative flex justify-center">
                            ...
                            <img src={starPurple} alt="star-icon" className="w-[12px] animate-pulse absolute left-[12rem] -top-[4rem] md:left-[7.5rem] md:-bottom-[1rem] md:w-[20px]" />
                            <img src={starGray} alt="star-icon" className="w-[12px] animate-pulse absolute right-[11rem] bottom-[7rem] md:right-[15rem] md:bottom-[12rem] md:w-[20px]" />
                        ...
                        <SingleArticle
                            ...
                            <>
                                ...
                                <img src={starWhite} alt="star-icon" className="w-[12px] animate-pulse absolute right-[2rem] bottom-[2rem] md:-left-[6.5rem] md:-bottom-[1rem] md:w-[20px]" />
                    ...
                    <article className="md:w-[80%] md:mx-auto md:grid md:grid-cols-2 md:gap-x-8 md:items-center py-[62px]">
                        ...
                        <SingleArticle
                            ...
                            <div className="relative">
                                ...
                                <img src={starPurple} alt="star-icon" className="w-[16px] animate-pulse absolute left-[5rem] -top-[5rem] md:-left-[1.5rem] md:-top-[8rem] md:w-[20px]" />
                            </div>
                        </SingleArticle>
                    </article>
                </section>
                ...
                <section className="pt-[80px] pb-[62px] mx-10 md:mx-[38px] lg:mx-[128px]" id="timeline">
                    ...
                    <Slide direction="up" className="relative md:mt-8">
                        ...
                        <img src={starPurple} alt="star-icon" className="w-[12px] animate-pulse absolute left-[1rem] -top-[2rem] md:left-[22rem] md:-top-[1rem] md:w-[20px]" />
                        <img src={starWhite} alt="star-icon" className="w-[12px] animate-pulse absolute right-[7.5rem] bottom-[22.5rem] md:right-[20rem] md:bottom-[23rem]" />
                        <img src={starGray} alt="star-icon" className="w-[12px] animate-pulse absolute -left-[1.5rem] -bottom-[2rem] md:left-[12rem] md:bottom-[1rem]" />
                    </Slide>
                </section>
                {/* End Timeline */}
                ...
                <section className="pb-[62px] pt-12 bg-primaryVariantOne shadow-sm" style={{
                    ...
                    <div className="relative mx-10 md:mx-[38px] lg:mx-[128px] md:flex md:justify-end">
                        ...
                        <img src={starPurple} alt="star-icon" className="w-[12px] animate-pulse absolute left-[2.5rem] -top-[3.5rem] md:left-[14rem] md:top-[2rem]" />
                        <img src={starPurple} alt="star-icon" className="w-[10px] animate-pulse absolute z-0 right-[5.5rem] bottom-[5rem] md:right-[10rem] md:bottom-[4.6rem] md:w-[20px]" />
                    </div>
                    <article className="md:w-[80%] md:mx-auto md:grid md:grid-cols-2 md:gap-x-8 md:items-center">
                        <div className="relative flex justify-center">
                            ...
                            <img src={starWhite} alt="star-icon" className="w-[12px] animate-pulse absolute left-[5rem] -bottom-[8px] md:left-[10rem] md:-bottom-[2rem]" />
                            ...
                            <Fade direction="right" delay={200} cascade fraction={0}>
                                {rewardsData.map(({ id, title, prize, image, bgColor, borderColor }, idx) => (
                                    <div key={id} style={{ border: '1px solid', borderColor: borderColor, backgroundColor: bgColor }} className={`w-[100px] h-[125] p-2 rounded-lg text-center pt-12 pb-4 relativ md:w-[180px] md:pt-24 md:p-5 ${idx !== 1 && 'mb-4 md:mb-8'}`}>
                                        ...
                                        <img src={image} alt="medal" className={`absolute left-0 right-0 bottom-0 m-auto w-[90px] inline-block md:w-[139px] ${idx === 1 ? '-top-48 -left-3 -mr-5  min-w-[136px] md:-mr-8 md:min-w-[235px] md:-top-[19rem] md:-left-7' : '-top-36 md:-top-60'}`} />
                                    </div>
                                ))}
                            </Fade>
                            <img src={starWhite} alt="star-img" className="absolute right-12 -top-20 md:right-0" />
                            <img src={starGray} alt="star-icon" className="w-[12px] animate-pulse absolute right-[9.5rem] -bottom-[1rem] md:right-[11rem] md:-bottom-[2rem]" />
                    ...
                    <article className="mx-10 md:mx-[38px] lg:mx-[128px]">
                        ...
                        <div className="border border-[#D434FE] rounded-[5px] p-5">
                            <div className="grid grid-cols-3 gap-4 justify-center items-stretch place-content-center relative md:w-[70%] md:mx-auto md:p-16">
                                ...
                                <img src={starPurple} alt="star-icon" className="w-[12px] animate-pulse absolute left-[1rem] bottom-[9rem] md:-left-[8rem] md:bottom-[23.5rem] md:w-[18px]" />
                                <img src={starPurple} alt="star-icon" className="w-[12px] animate-pulse absolute right-[7.5rem] bottom-[5.5rem] md:right-[22rem] md:bottom-[20rem]" />
                                <img src={starWhite} alt="star-icon" className="w-[12px] animate-pulse absolute right-3 -bottom-4 md:right-[22rem] md:bottom-12" />
                    ...
                    <article className="md:grid md:grid-cols-2 md:gap-x-8 md:items-center">
                        <div>
                            <div className="mx-10 relative md:mx-0 md:flex md:justify-left">
                                ...
                                <img src={starGray} alt="star-icon" className="w-[8px] animate-pulse absolute right-7 -top-7 md:left-80 md:-top-2 md:w-[16px]" />
                                <img src={starPurple} alt="star-icon" className="w-[14px] animate-pulse absolute -right-6 -bottom-28 md:hidden" />
                            </div>
                            ...
                            <Slide className="p-5 relative border border-[#D434FE] bg-[#D434FE]/5 rounded-[5px] md:p-16">
                                <>
                                    ...
                                    <img src={starPurple} alt="star-icon" className="w-[12px] animate-pulse absolute -left-6 bottom-48 md:-left-20" />
