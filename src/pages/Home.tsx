                        ...
                        <div className="flex gap-x-4 justify-center items-center mt-32 md:gap-x-6 relative">
                            <Fade direction="right" delay={200} cascade fraction={0}>
                                {rewardsData.map(({ id, title, prize, image, bgColor, borderColor }, idx) => (
                                    <div key={id} style={{ border: '1px solid', borderColor: borderColor, backgroundColor: bgColor }} className={`w-[100px] h-[125] p-2 rounded-lg text-center pt-12 pb-4 relative md:w-[180px] md:pt-24 md:p-5 ${idx !== 1 && 'mb-3'}`}>
                                        ...
                                        <img src={image} alt="medal" className={`absolute left-0 right-0 bottom-0 m-auto w-[90px] inline-block md:w-[139px] ${idx === 1 ? '-top-48 -left-9  min-w-[136px] md:min-w-[235px] md:-top-[19rem] md:-left-7' : '-top-32 md:-top-60'}`} />
                                    </div>
                                ))}
                            </Fade>
