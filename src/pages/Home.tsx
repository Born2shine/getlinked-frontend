...
import { avatarVR, bigIdeaImg, bulb, chain, checkIcon, cicleNetwork, contactIcon, curveLine, fireBoom, gradientBg, illustrationFive, illustrationFour, illustrationOne, illustrationThree, illustrationTwo, mapIcon, plusIcon, starGray, starPurple, starPurpleOne, starWhite } from "../assets"
import { LensFlare, Logo, SpecialText, TimeLabel } from "../atoms"
import { ArticleTitle, Button, Footer, SingleArticle } from "../components"
import { faqsData, homeLinks, judgingCriteriaData, partnerLogo, rewardsData, socialIcons, timelineData } from "../utils"
                    ...
                    <aside className="text-center mt-[58px] relative md:text-start">
                        <div className="font-clashBold text-[32px] relative z-10 lg:text-[60px]">
                            <div className="flex justify-center relative md:justify-start">
                                <h1 className="relative w-fit lg:leading-[5rem]">getlinked Tech
                                    <img src={bulb} alt="bulb" className="w-[20px] absolute right-4 -top-3 md:w-[35px] md:-top-8 md:right-6" />
                            ...
                            <div className="flex items-center justify-center md:justify-start">
                                <h1 className="leading-6">Hackathon <SpecialText title="1.0" /></h1>
                                <img src={chain} alt="chain" className="w-[32px] md:w-[56px]" />
                                <img src={fireBoom} alt="fire-boom" className="w-[32px]" />
                            </div>
                        </div>
                        <p className="text-[13px] w-[70%] mx-auto mt-[9px] md:text-[16px] md:mx-0">
                        ...
                        <Button title="Register" extraClass="mt-[1.5rem]" />
                ...
                <section className="border-b border-b-slate-800 bg-[#140D27]">
                    <article className="md:w-[80%] md:mx-auto md:grid md:grid-cols-2 md:items-center py-[62px]">
                        <div className="relative flex justify-center">
                            <img src={bigIdeaImg} alt="big-idea-img" className="w-[264px] md:w-[400px]" />
                    ...
                    <article className="md:w-[80%] md:mx-auto md:grid md:grid-cols-2 md:gap-x-8 md:items-center py-[62px]">
                        ...
                        <SingleArticle
                            ...
                            <>
                                ...
                                <div className="flex justify-center md:justify-start"><Button title="Read More" extraClass="mt-5" /></div>
                        ...
                        <div className="flex gap-x-4 justify-center items-center mt-32 md:gap-x-6 relative">
                            {rewardsData.map(({ id, title, prize, image, bgColor, borderColor }, idx) => (
                                <div key={id} style={{ border: '1px solid', borderColor: borderColor, backgroundColor: bgColor }} className={`w-[90px] h-[125] p-2 rounded-lg text-center pt-12 pb-4 relative md:w-[180px] md:pt-24 md:p-5 ${idx !== 1 && 'mb-3'}`}>
                                    ...
                                    <img src={image} alt="medal" className={`absolute left-0 right-0 bottom-0 m-auto w-[76px] md:w-[139px] ${idx === 1 ? '-top-48 -left-5 min-w-[125.67px] md:min-w-[226px] md:-top-[19rem] md:-left-7' : '-top-32 md:-top-60'}`} />
                                </div>
                            ))}
                            ...
                            <div className="grid grid-cols-3 gap-4 justify-center items-stretch place-content-center relative md:w-[70%] md:mx-auto md:p-16">
                                {
                                    partnerLogo.map(({ id, image }, idx) => (
                                        <div key={id} className={`${idx < 3 && 'border-b-2'} ${idx !== 2 && idx !== 5 && 'border-r-2'} border-r-[#D434FE] border-b-[#D434FE] p-3 grid place-content-center relative after:w-7 after:h-7 after:rounded-full after:bg-primaryVariantOne after:absolute after:top-12 after:left-[4.5rem] md:after:top-20 md:after:left-[7rem] lg:after:top-[5.5rem] xl:after:left-[12.5rem] ${idx > 1 && 'after:hidden'}`}>
                ...
                <section className="pb-[62px] pt-20 bg-primaryVariantOne mx-10 md:mx-[38px] lg:mx-[128px]">
                    <article className="md:grid md:grid-cols-2 md:gap-x-8 md:items-center">
                        <div>
                            ...
                            <p className="text-[14px] text-center mb-[45px] md:mx-0 md:w-[85%] md:text-left">Below are our privacy & policy, which outline a lot of goodies.
                                it’s our aim to always take of our participant</p>
                            <div className="p-5 relative border border-[#D434FE] bg-[#D434FE]/5 rounded-[5px] md:p-16">
